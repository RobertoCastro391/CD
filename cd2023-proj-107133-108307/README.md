...
Executar o ficheiro bash executeMac.sh, caso seja o sistema operativo MacOS, ou executar executeLinux.sh, caso o sistema operativo seja Ubunto.

Ir para o link http://127.0.0.1:5100 e submeter uma musica e processar

Para parar a execução de tudo roda deleteMac.sh ou deleteLinux.sh, consoante o sistema operativo!
